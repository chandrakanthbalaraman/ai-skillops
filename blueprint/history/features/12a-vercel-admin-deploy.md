...
- [x] **Step 3 - Deploy to Vercel** - Link/create the Vercel project for
...
- [x] **Step 4 - Set Vercel env and redeploy if needed** - Configure
...
- [x] **Step 5 - Live smoke** - Hit the live `/login` and `/` URLs. *Done when:*
...
- https://ai-skillops-admin.vercel.app
